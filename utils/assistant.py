...
class AssistantManager:
    ...
    async def generate_meal_plan(self, user_data):
        ...
        prompt = (
            ...
            "- Show target protein, carbs, fats in format: 'Nutrient: Xg'\n"
            "- Display daily calorie target as 'Target: X calories'\n\n"
            "**Suhoor - 45 min before Fajr:**\n"
            "- Each food item on new line with '-'\n"
            "- Include exact portions (e.g., '3 large eggs')\n"
            "- End with clear 'Meal Totals'\n\n"
            "**Iftar - At Maghrib:**\n"
            "- Same format as Suhoor\n"
            "- Include exact portions\n"
            "- End with clear 'Meal Totals'\n\n"
            "**Post-Taraweeh:**\n"
            "- Same format as other meals\n"
            "- Include exact portions\n"
            "- End with clear 'Meal Totals'\n\n"
